...
private:
    ...
    void printInOrder(DNode* node) const;
    void deleteTree(DNode* node);
    DNode* copyTree(DNode* node);
    DNode* search(DNode* node, int disc);
    DNode* insertNode(DNode* node, Account acc);
    bool doesExist(DNode* node, int disc);
    void fillArray(DNode* node, DNode ** array, int& index);
    DNode* balanceTree(DNode** array, int start, int end);
    DNode* removeNode(DNode* node, int disc, DNode*& removed);
    void fillVacant(DNode* node, Account acc);
};
